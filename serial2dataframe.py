...
#
#   Difference to serial2CSV : first step read data into a pandas dataframe.
#                               second : after collecting store dataframe into CSV
#
#
#   This tool was developed only as a feasibility study if collecting directly into a dataframe
#   (yes it works ;-) 
#
